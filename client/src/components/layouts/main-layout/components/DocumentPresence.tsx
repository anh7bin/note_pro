        ...
        <PopoverPanel
            ...
            <div className="max-h-70 overflow-y-auto">
                {users.map((user) => (
                    <div
                        key={user.id}
                        className="flex min-w-0 items-center gap-3 rounded-md px-1 py-1">
                        <span className="relative shrink-0">
                            <UserAvatar
                                ...
                                size={24}
                            />
                            <span className="absolute bottom-0 right-0 size-2 rounded-full border-2 border-popover bg-emerald-500" />
                        </span>
