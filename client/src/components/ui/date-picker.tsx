    ...
    return (
        <PopoverPanel
            ...
            trigger={
                <Button
                    variant="ghost"
                    className="h-8 justify-start border border-input bg-surface px-3 text-left font-normal text-muted-foreground hover:border-border-strong hover:bg-accent hover:text-foreground">
