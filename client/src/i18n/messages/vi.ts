...
export const vi: Messages = {
    ...
    coverLibrary: 'Thư viện',
    uploadCover: 'Tải lên',
    updatingCover: 'Đang cập nhật ảnh bìa...',
    coverColorsGradients: 'Màu & gradient',
    coverTextures: 'Texture',
    selectCoverOption: 'Chọn ảnh bìa số {{index}}',
    uploadCoverTitle: 'Chọn ảnh từ thiết bị',
    uploadCoverDescription: 'Nhấn để duyệt tệp trên máy của bạn',
    supportedCoverFormats: 'JPG, PNG, WebP hoặc GIF · Tối đa 10 MB',
    documentCoverUpdateError: 'Không thể cập nhật ảnh bìa tài liệu',
    copyLink: 'Sao chép liên kết',
    duplicateDocument: 'Nhân bản',
    duplicatingDocument: 'Đang nhân bản tài liệu',
    documentCopySuffix: '(Bản sao)',
    documentDuplicated: 'Đã nhân bản tài liệu',
    documentDuplicateError: 'Không thể nhân bản tài liệu. Vui lòng thử lại.',
