export const en = {
    ...
    coverColorsGradients: 'Colors & gradients',
    coverTextures: 'Textures',
    selectCoverOption: 'Select cover option {{index}}',
    uploadCoverTitle: 'Choose an image from your device',
    uploadCoverDescription: 'Click to browse your local files',
    supportedCoverFormats: 'JPG, PNG, WebP or GIF · Max 10 MB',
    documentCoverUpdateError: 'Could not update the document cover',
    copyLink: 'Copy link',
    duplicateDocument: 'Duplicate',
    duplicatingDocument: 'Duplicating document',
    documentCopySuffix: '(Copy)',
    documentDuplicated: 'Document duplicated',
    documentDuplicateError: 'Could not duplicate the document. Try again.',
    moveTo: 'Move to',
